...
<body>
	...
	<div class="row">
		<div class="col-lg-7 mt-1" style="background-color:whitesmoke ;">
			...
			<?php
			$UserId = $_SESSION['Id'];
			$sql = "SELECT ProductId FROM `cart_info` WHERE `UserId` = 12";
			$cart = mysqli_query($connection, $sql);
			if (mysqli_num_rows($cart) > 0) { ?>
			<table class="table table-hover table-inverse table-responsive-lg" style="font-weight: 500;"
				...
				<tbody>
					...
					<tr>
						...
						<td scope="row no-gutters d-inline">
							<div class="media">
								<a class="d-flex" href="#">
									<img src="ADMIN PANEL/Images/<?php echo $c_details['img'] ?>" alt=""
										style="width: 70px; height:70px;">
								</a>
								<div class="media-body ml-4">
									<h6 style="color:brown;font-family:monospace"> <?php echo $c_details['name'] ?>
									</h6>
									...
									<form action="remove_item_from_cart.php" method="post">
										<?php
														$UserId = $_SESSION['Id'];
														?>
										<input type="text" name="order_id" value="<?php echo  $product_id ?>"
											class="form-control" placeholder="" aria-describedby="helpId" hidden>
										<input type="text" name="user_Id" class="form-control"
											value="<?php echo $UserId ?>" placeholder="" aria-describedby="helpId"
											hidden>
								...
								<div class="row no-gutters">
									<div class="col mr-0">
										<form action="delete.php" method="post">
											...
											<button type="submit" disabled="disabled" class="btn btn-light"
												style="border-radius: 0px;height:40px" name="subtract"> <i
											...
											<input type="text" name="order_id"
												value="<?php echo $cart_quantity['Id'] ?>" class="form-control"
												placeholder="" aria-describedby="helpId" hidden>
									...
									<div class="col">
										<button type="button" class="btn btn-success ml-0 mr-0"
											style="border-radius: 0px;height:40px;width:85%;" value="">
									...
									<div class="col">
										<form action="add.php" method="post">
											...
											<button type="submit" disabled="disabled" class="btn btn-light"
												style="border-radius: 0px;height:40px" value="" name="add"> <i
		...
		<div class="col-lg-4 col-sm-12 col-md-12" ">
			...
			<div class="card-footer">
				...
				$UserId = $_SESSION['Id'];
				?>
				<a href="checkout.php?user_id = <?php echo $UserId ?>&amount =<?php echo $Total ?>"
					style="text-decoration:none"><button type="button" class="btn btn-dark d-block mt-2"
						style="border-radius: 0px; width:98%">CHECKOUT</button></a>
			</div>
		</div>
