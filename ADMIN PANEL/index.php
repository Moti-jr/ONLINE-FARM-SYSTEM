	...
	<div class="mt-1" style="background-color:rgb(220, 220, 220);">
		...
		<div class="wrapper">
			<nav class="sidebar nav flex-column" id="sidebar" style="background-color:gainsboro;">
				...
				<li class="nav-item">
					<a class="sb nav-link" href="pages/add_product.php" style="color:orange"><i class=" fa fa-plus"
							aria-hidden="true"></i>
			...
			<div class="content" id="content" style="background-color: white;width:100%">
				<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: green;">
					...
					<ul class="navbar-nav ml-12 mt-2 mt-lg-0 pl-lg-5 ml-sm-0">
						...
						<li class="nav-item active  mr-sm-0 ml-5">
							<a href="pages/logout.php"><button type="submit" name="logout"
				...
				<div class="ml-5 col-lg-10 col-md-10 col-sm-10 mt-0"
					style="border:2px solid gainsboro;box-shadow:2px 2px 10px;margin-left:20px">
