...
<body>
	<div class="container-fluid mt-1" style="background-color:rgb(220, 220, 220);">
		...
		<div class="jumbotron jumbotron-fluid mb-1"
			style="background-image: url(Images/background4.jpg);background-size:cover;background-repeat:no-repeat;">
			<div class="container mx-auto">
				<center>
					...
					<p class="lead mt-5">
						<a class="btn btn-outline-success btn-lg" href="Jumbo action link" role="button"
							style="border-radius:20px;">Order Now</a>
					</p>
				</center>
			</div>
		</div>
