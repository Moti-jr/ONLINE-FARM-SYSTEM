			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<p class="mb-4">This tables contains all the information that are there in the database
							regarding the Users in our system. It is detailed and easy to update ad delete Users. It
							helps the admin access the Users to ascertain the effectiveness of each and every data
							stored about them</p>
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<?php
                                $sql = "SELECT * FROM users  ORDER BY `users`.`Date Ragistered` ASC";
								...
								<div class="table-responsive">
									<table class="mr-5 table table-bordered" id="dataTable" width="100%"
										...
										<tfoot>
											...
											<tr>
												<th><?php echo $num ?></th>
												<th> <img src="Images/users/<?php echo $row['File'] ?>" alt=""
														style="width:90px; height:90px;"></th>
													...
													<div class="row">
														<div class="col-lg-6">
															<button type="button" class="btn btn-success px-1"
																data-toggle="modal"
																data-target="#product_modal<?php echo $row['Id'] ?>">Update</button>

															<!-- Modal -->
															<div class="modal fade"
																id="product_modal<?php echo $row['Id'] ?>" tabindex="-1"
																...
																<div class="modal-dialog modal-lg" role="document">
																	<div class="modal-content">
																		...
																		<div class="modal-body">
																			<center>
																				<img src="IMAGES/Users/<?php echo $row['File'] ?>"
																					alt=""
																				...
																				<form id="myform" action=""
																					...
																					<div class="row mx-2 mt-3">
																						<div class="col form-group">
																							...
																							<input type="text"
																								...
																								autocomplete="off"
																								value="<?php echo $row['Customer Name'] ?>"
																								required>
																						</div>
																						<div class="col form-group">
																							<label for=""
																							...
																							<input type="text"
																								...
																								aria-describedby="helpId"
																								autocomplete="off"
																								value="<?php echo $row['Customer Username']  ?>"
																								required>
																						</div>
																					</div>
																					...
																					<div class="row ml-2">
																						<div
																							class="col form-group mt-3 mb-3">
																							<label for=""
																								style="font-weight:700;">
																						...
																						<div
																							...
																							<input type="text"
																								...
																								id="Email"
																								class="form-control"
																								value="<?php echo $row['Phone Number'] ?>"
																								placeholder=""
																								aria-describedby="helpId">
																						</div>
																					</div>
														...
														<div class="col-lg-6">
															<a href="?userId=<?php echo $row['Id'] ?> "><button
																	type="button" class="btn btn-danger px-1">Delete
																</button></a>
														</div>
