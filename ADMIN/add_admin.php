				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-8 mx-auto my-3">
							<div class="col-lg-11 mx-auto mt-3 py-2"
								style="background-color:whitesmoke;border:1px solid orange;box-shadow:2px 2px 10px ;">
								...
								<form id="myform" action="" method="post" enctype="multipart/form-data">
									<div class="row mx-2">
										<div class="col form-group">
											...
											<input type="text" name="name" id="name" class="form-control" placeholder=""
												aria-describedby="helpId" autocomplete="off" value="<?php echo $name ?>"
												required>
									...
									<div class="row mx-2">
										...
										<div class="col form-group mt-3 mb-3">
											...
											<input type="password" id="conpassword" autocomplete="off"
												class="form-control" placeholder="" aria-describedby="helpId"
												value="<?php echo $pass ?>" required>
									...
									<div class="row ml-2">
										<div class="col form-group mt-3 mb-3">
											...
											<input type="email" name="Email" autocomplete="off" id="Email"
												class="form-control" value="<?php echo $email ?>" placeholder=""
									...
									<div class="ml-3 form-group">
										...
										<input type="file" class="form-control" name="file" id="" placeholder=""
											value="<?php echo $filename ?> aria-describedby=" fileHelpId"
