...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$sql = "UPDATE `admin` SET `full_name`='$admin_name',`contact`='$phone_number',`email_address`='$email',`username`='$admin_username',`address`='$address' WHERE `Id`='$Id'";
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-lg-8 mx-auto my-2 pb-3" style="box-shadow:2px 2px 10px; height:auto;">
							<center>
								<img src="IMAGES/users/<?php echo $menu['profile_image'] ?>" alt="" class="mt-2 mb-1"
								...
								<form action="" method="POST">
									<div class="form-row">
										...
										<div class="col-md-6 mb-3">
											...
											<input type="text" class="form-control " id="validationServer01"
												placeholder="First name" name="admin_name"
												value="<?php echo $menu['full_name'] ?>" required>
										...
										<div class="col-md-6 mb-3">
											...
											<input type="text" class="form-control" id="validationServerUsername"
												...
												id="validationServerUsername" value="<?php echo $menu['username'] ?>"
									...
									<div class="form-row">
										<div class="col-md-6 mb-3">
											...
											<input type="text" class="form-control" name="address"
												id="validationServer03" value="<?php echo $menu['address'] ?>" required>
										...
										<div class="col-md-6 mb-3">
											...
											<input type="text" class="form-control" id="validationServer04"
												...
												value="<?php echo $menu['contact'] ?>" required>
									...
									<div class="form-row">
										<div class="col-md-6 mb-3">
											...
											<input type="text" class="form-control" name="email" id="validationServer05"
												placeholder="Email" value="<?php echo $menu['email_address'] ?>"
												required>
											<div class="valid-feedback">
												Looks good!
											</div>
