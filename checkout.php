		...
		<div class="col-lg-8 mt-1 mx-auto" style="box-shadow:1px 1px 10px">
			...
			<div class="card text-dark bg-light mt-1">
				<div class="card-body">
					<div class="row">
						<div class="col-lg-10">
							<h3 class="text mb-3" style="font-family: monospace; font-size:20px;font-weight:600"><i
						...
						<div class="col-lg-2">
							<div class="edit py-4" style="cursor:pointer;">
								<i class=" fa fa-edit fa-2x" aria-hidden="true" data-toggle="modal"
									data-target="#modelId"></i><!-- Button trigger modal -->
												...
												<div class="container-fluid">
													<div class="row">
														<div class="col-lg-6 mx-auto">
															<center><img src="images/logo2.jpg" alt=""
															...
															<div class="col-lg-6">
																<div class="input-group">
																	<div class="input-group-text"
																		style="border-radius:0px; width:35px"> <i
														...
														<div class="row d-flex justify-content-around">
															<div class="col">
																<button type="submit" class="btn btn-primary"
																	style="float:right">Update User Details</button>
															</div>
														</div>
													</form>
												</div>
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-lg-2">
							<div class="edit py-4" style="cursor:pointer;">
								<i class=" fa fa-edit fa-2x" aria-hidden="true" data-toggle="modal"
									data-target="#transaction_method"></i>

								<!-- Modal -->
								<div class="modal fade" id="transaction_method" tabindex="-1" role="dialog"
									aria-labelledby="modelTitleId" aria-hidden="true">
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											<div class="modal-body">
												<div class="alert alert-warning" role="alert">
													<h4 class="alert-heading"><i class="fa fa-exclamation-circle"
															aria-hidden="true"></i> Pickup is the only Available
														Option. </h4>
													<p></p>
													<p class="mb-0"></p>
												</div>
			...
			<div class="card text-dark bg-light mt-2 mb-2">
				<div class="card-body">
					<div class="row">
						<div class="col-lg-10">
							<h3 class="text mb-3" style="font-family: monospace; font-size:20px;font-weight:600"><i
									class="fas fa-dollar-sign"></i> PAYMENT METHOD</h3>
							<div class="name pl-4">
							...
							<div class="row">
								...
								<div class="col-lg-2 py-auto" style="float:right;">
									<?php
										...
										foreach ($total as $total) {
											$Total = (float)$total['Amount']; ?>
									<a href="PHP-MPESA/MpesaProcessor.php?amount=<?php echo $Total ?>"
										class="btn btn-outline-success"
										style="box-shadow:2px 2px 10px green">checkout</a>
									<?php }
										?>
								</div>
							</div>
							...
							<div class="mpesa_div pt-3 mb-3" style="background-color: green; ">
								<center>
									...
									<div class="paybill_number "
										style="background-color: white; color:green; width:50%;height:auto">
										<div class="number">
											<span style="font-weight: 800; font-size:22px">1 7 4 3 7 9</span>
										</div>
									</div>
									<div class="paybill_footer pb-3"
										style="background-color: green;  width:100%;height:4px">
									</div>
								</center>
							</div>
							<form action="transaction.php" method="post" class="form mb-2">
								<div class="form-group">
									...
									<input type="text" name="payment_voucher" id="" class="form-control" placeholder=""
										autocomplete="off" aria-describedby="helpId" required>
								</div>
								<input type="text" name="paid_by" id="" value="<?php echo $UserId ?>" hidden>
								<input type="text" name="Amount" id="" value="<?php echo $Total ?>" hidden>
								<input type="text" name="payment_date" id="" value="<?php echo date("l d/ m/Y") ?>"
									hidden>
								<?php
